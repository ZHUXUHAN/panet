...
def cfg():
    ...
    if mode == 'train':
        ...
        notrain = False
        snapshot = '/home/voc_/PANet-master/runs/PANet_VOC_align_sets_2_1way_5shot_[train]/2/snapshots/30000.pth'
        n_runs = 5
        n_steps = 1000
        batch_size = 1
        scribble_dilation = 0
    ...
    path = {
        ...
        'VOC':{'data_dir': '/home/voc_/VOCdevkit/VOC2012/',
               'data_split': 'trainaug',},
        'COCO':{'data_dir': '/home/voc_/mscoco2014',
                'data_split': 'train',},
    }
